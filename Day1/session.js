// console.log('hello reem!!')
// // the js will turn the str into int to make it and not ouput the error
// var v='5'*'34'
// console.log(v)
...
// ]
// let v1=data[data.length-1]
// let v2=v1[v1.length-1]
// let v3=v2[v2.length-1]
// let v4=v3[v3.length-1]
// let v5=v4[v4.length-1]
// console.log(v1)
// console.log(v2)
// console.log(v3)
// console.log(v4)
...
//   "limit": 30
// }
// console.log(data.posts[data.posts.length-1].views)
...
// console.log(arr)
// arr.push('hello') // add from end
// console.log(arr)
// arr.unshift('world') // add from start
// console.log(arr)

// delete arr[2] // it remove the val and still take the place
// console.log(arr)
...
// let flatarr=[[1,2,3,[2,3,4,5,5,6,6,6,4]],[4,5,6,7],'gee']
// flatarr=flatarr.flat() // it delete the instead list and make it all one list and the number to specific the num of instead lists it  should flat
// console.log(flatarr)

// let splicearr=['ban','cds','gfd']
// splicearr.splice(0,1) // it remove from index 0(the start point) to index 1 - 1 (the end point)
// splicearr.splice(1,1,'omar')
// console.log(splicearr)


// the diff btw the splice and slice 
// slice- > take a copy and make a change in it and return the deleted part
// splice -> it return the deleted part and  it delete from the original array fromt the start index to the index before the last one
let slicearray=['banana','apple','lemon','orange','mango']
// const slicearr=slicearray.slice(1,3)
// const splicearr=slicearray.splice(1,3)
// console.log(slicearr) // it return the part we delete
// console.log(splicearr) // it return the part we delete
// console.log(slicearray) // it return the val of arr after the splice 

const slicearr1=slicearray.slice(1,-1)
const slicearr2=slicearray.slice(-1,-3)
// const splicearr=slicearray.splice(-1,3)
